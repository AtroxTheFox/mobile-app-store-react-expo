...
import angry_birds1 from './assets/angry_birds1.webp';
import angry_birds2 from './assets/angry_birds2.webp';
import angry_birds3 from './assets/angry_birds3.webp';
import avicii_cover from './assets/avicii.jpg';
import ice_cube_cover from './assets/ice_cube.jpeg';
...
export default function App() {
  ...
  const handleCategoryIceCube = () => {
    setCurrentPage('IceCube');
  }
      ...
      return (
        <ScrollView>
          ...
          <TouchableOpacity onPress={handleAccount}>
            <Text style={styles.ctText}>account</Text>
          </TouchableOpacity>
    ...
    <View style={styles.container}>
      ...
      {currentPage === 'music' && (
        <View style={styles.musicPage}>
          ...
          <TouchableOpacity style={styles.musicPageTouchableOpacity} onPress={() => handleCategoryClick('all music')}>
            <View style={styles.orangeBox}>
              ...
              <TouchableOpacity style={styles.updatePageTouchableOpacity} onPress={() => handleCategoryIceCube('IceCube')}>
                <View style={styles.dwButton}></View>
                  <Text style={styles.dwboxText}>Ice Cube - It Was a Good Day</Text>
        ...
        {currentPage === 'IceCube' && (
          ...
          <View style={styles.aboutPage}>
            <Image source={ice_cube_cover} style={{width: 200, height: 200, marginTop: 20,}} />
            <Text style={styles.abheaderText}>It Was a Good Day</Text>
            <Text style={styles.abText}>Ice Cube</Text>
            <Text style={styles.abText}>1.29$</Text>
      ...
      {currentPage === 'update' && (
        <View style={styles.aboutPage}>
          ...
          <Text style={styles.abText}>Current version: Alpha 1.0</Text>
          <Text style={styles.abText}>Build: 000001</Text>
        </View>
      )}
      {currentPage === 'about' && (
        <View style={styles.aboutPage}>
          <Text style={styles.abheaderText}>WRE Store</Text>
          <Text style={styles.abText}>Version: Alpha 1.0.0.0</Text>
          <Text style={styles.abText}>Build: 000001</Text>
          <Text style={styles.abText}>© 2024 Jan Kadlčík & Stanislav Vykoukal</Text>
...
{currentPage === 'account' && (
      <View style={styles.aboutPage} >
        <Text style={styles.abText}>no user logged in</Text>

        <View style={styles.dwButton}>
          <Text style={styles.dwboxText}>login</Text>
        </View>

        <Text style={styles.abText}>troubles logging in?</Text>
      </View>
      )}
      ...
      {currentPage === 'Angry Birds' && (
        ...
        <View style={styles.aboutPage}>
          ...
          <Text style={styles.abheaderText}>About</Text>
          <Text style={styles.abText}>Join hundreds of millions of players for FREE and start the fun slingshot adventure now! Team up with your friends, climb the leaderboards, gather in clans, collect hats, take on challenges, and play fun events in all-new game modes. Evolve your team and show your skills in this exciting Angry Birds game!</Text>
          <Text style={styles.abText}>Get to know all of the iconic Angry Birds characters and experience the fun gameplay that has captured the hearts of millions of players</Text>
          <Image source={angry_birds1} style={{width: 320, height: 200, marginTop: 20,}} />
          <Image source={angry_birds2} style={{width: 320, height: 200, marginTop: 20,}} />
          <Image source={angry_birds3} style={{width: 320, height: 200, marginTop: 20,}} />
        </View>
        </ScrollView>
      )}
    </View>
